...
<?php include 'helper/header.php'?>
    ...
    <div class='navbar navbar-dark bg-primary d-flex justify-content-center'>
        <form class='form-inline' action='transactionManagement.php' name='searchTransactions' method='post'>
            ...
            <button class='form-control btn btn-success' type='submit'>Search Faculty!</button>
        </form>
    </div>
    ...
    <h1 class='text-center'><strong>My Transactions</strong></h1>
        <?php
            ...
            if($_POST['transactionSearchValue']){
                ...
                $transactionQuery = "SELECT * FROM Transaction WHERE memberID = '$_SESSION[memberID]' ORDER BY transactionPaymentDate ASC, transactionApprovalDate ASC";
                /*
                // Value is name, do a search on the name
